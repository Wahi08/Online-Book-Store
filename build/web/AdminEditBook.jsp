            ...
            <div class="col py-3">
                ...
                <form id="add" action="BookServlet" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control-file" name="image" value="<c:out value='${book.image}' />"required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" value="<c:out value='${book.title}' />" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="author" value="<c:out value='${book.author}' />" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="description" name="description" style="height: 100%;" value="<c:out value='${book.description}' />"  required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="<c:out value='${book.category}' />" class="form-control" readonly/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="value" class="form-control" name="price" style="width: 20%;" value="<c:out value='${book.price}' />" required>
                        </div>
                    </div>

                    <input type="hidden" name="id" value="<c:out value='${book.id}' />" >
                    <a><input type="submit" value="Update"><a>
                            <a><input type="reset" value="Cancel"><a>
