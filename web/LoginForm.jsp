<%-- 
    Document   : LoginForm
    Created on : Jun 8, 2022, 5:44:41 AM
    Author     : Lenovo
--%>
...
<body>
    ...
    <div class="main-content">
		...
		<a href="RegisterForm.jsp" class="form-log-in-with-existing">You Don't have an account? <b> Register here </b></a>
                <br><br> <br><br>
                <a href="AdminLoginForm.jsp" class="form-log-in-with-existing">Admin? <b> Click Here </b></a>
